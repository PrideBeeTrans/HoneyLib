tool
class_name Component2D,"res://addons/HoneyLib/Icons/Component2D.svg"
extends Node2D
...
func _get_property_list() -> Array:
	...
	properties.create_component_base("Component2D", _include_resource_map(), is_registry_by_name())

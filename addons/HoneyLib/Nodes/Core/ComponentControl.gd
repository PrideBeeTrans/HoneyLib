tool
class_name ComponentControl,"res://addons/HoneyLib/Icons/ComponentControl.svg"
extends Control
...
func _get_property_list() -> Array:
	...
	properties.create_component_base("ComponentControl", _include_resource_map(), is_registry_by_name())

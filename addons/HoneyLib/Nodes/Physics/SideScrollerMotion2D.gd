tool
class_name SideScrollerMotion2D,"res://addons/HoneyLib/Icons/Physics/SideScrollerMotion2D.svg"
extends PhysicsMotion2D


var move_settings : Resource
var gravity_settings : Resource
...
func acceleration_to(move_direction: Vector2) -> void:
	...
	get_actor().set_velocity_x(lerp(get_actor().get_velocity_x(), move_to, weight))
...
func get_class() -> String:
	return "SideScrollerMotion2D"


func _get_property_list() -> Array:
	var properties := PropertiesList.create_property_list()
	properties.add_category("SideScrollerMotion2D")
